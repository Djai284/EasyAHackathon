...
const Navbar = () => {
  ...
  return (
    <header className={`fixed w-full z-30 md:bg-opacity-90 transition duration-300 ease-in-out ${top && 'invisible'}`}>
        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="hidden md:flex md:grow">
            ...
            <ul className="flex grow justify-end flex-wrap items-center">
              ...
              <li>
                <Link href="/signup">
                  <div className="flex px-4 py-2 text-gray-200 bg-gray-900 hover:bg-gray-800 ml-3">
                    <span> Sign up</span>
                  </div>
                </Link>
              </li>
