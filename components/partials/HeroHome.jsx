          ...
          <div className="text-center pb-12 md:pb-16">
            ...
            <div className="max-w-3xl mx-auto">
              <p className="text-xl text-gray-600 mb-8" data-aos="zoom-y-out" data-aos-delay="150">
                Make your computer faster with a click of a button!
              </p>
              <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center" data-aos="zoom-y-out" data-aos-delay="300">
                <div className="">
                  <button className=" px-4 py-2 text-white bg-orange-500 hover:bg-orange-400 w-full mb-4 sm:w-auto sm:mb-0" href="#0">
                    Check out free demo!
                  </button>
                </div>
                <div className="">
                  <button className="px-4 py-2 text-white bg-gray-900 hover:bg-gray-800 w-full sm:w-auto sm:ml-4" href="#0">
                    Learn more
                  </button>
                </div>
              </div>
