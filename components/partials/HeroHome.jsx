...
export default function HeroHome(props) {
  ...
  return (
    <section className="relative" id={props.id}>
      <div className="flex h-screen justify-center items-center max-w-5xl mx-auto px-4 sm:px-6">
        {/* Hero content */}
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          {/* Section header */}
          <div className="animate__animated animate__fadeInDown text-center p-12 md:pb-16 relative rounded-2xl">
            {/* <h1 className="text-6xl lg:text-8xl font-extrabold leading-tighter tracking-tighter mb-4" data-aos="zoom-y-out">
              Welcome to
              <span className="bg-clip-text text-transparent ml-2 px-2 bg-gradient-to-r from-orange-500 to-yellow-400">
                Solis
              </span>
            </h1> */}
            <img src="MindPalette.png" />
            {/* <div className="flex mt-4 gap-x-2">
              ...
              >
                <div className="mx-auto flex">
                  ...
                  <p className="flex ml-2 text-lg text-white">
                    Sign in with Google
                  </p>
                </div>
              </button>
            </div> */}
            <img src="Piece.png" className="w-80 mx-auto"/>
          </div>
