      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-6">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="shrink-0 mr-4">
            {/* Logo */}
            <Link href="/" className="block" aria-label="Solis">
            ...
            <div ref={mobileNav}>
              ...
              >
                <ul className="px-5 py-2">
                  ...
                  <li>
                    <Link href="/signin" className="flex font-medium w-full text-gray-600 hover:text-gray-900 py-2">
                      Log in
                    </Link>
                  </li>
                  <li>
                    <Link href="/signup">
                      <button classname="flex font-medium text-white hover:bg-gray-800 w-full px-8 py-4">
                        Sign up
                      </button>
                    </Link>
                  </li>
