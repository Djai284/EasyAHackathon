    ...
    <div className='flex h-screen'>
      ...
      <div className="animate__animated animate__fadeInDown w-full px-4 sm:px-6 lg:px-20 m-auto bg-white rounded-2xl sm:max-w-lg ">
        ...
        {/* <form className="mt-6">
          ...
          <div className="mt-6">
            <button className="w-full px-4 py-2 tracking-wide text-lg text-white transition-colors duration-200 transform bg-orange-600 rounded-md hover:bg-orange-500 focus:outline-none focus:bg-orange-500">
              Login
            </button>
          </div>
        </form> */}
        ...
        <button
          ...
          >
            <div className='mx-auto flex'>
              ...
              <p className="flex ml-2 text-lg text-white">Sign in with Google</p>
            </div>
